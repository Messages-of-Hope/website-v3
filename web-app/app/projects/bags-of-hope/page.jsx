  ...
  return (
    <main>
      ...
      <ImagePanel wide blue right image="AA6lgpnyoV" altText="Bethan Evans delivering bags of hope to a ward at Llandough hospital">
        <h3 className={styles.title}>What is Bags of Hope?</h3>
        <p className={styles.text}>Bags of Hope is a project to give items to patients arriving on psychiatric wards. Our goal is to ensure that nobody arrives to psychiatric wards with only the clothes on their back. Patients should be there for treatment and help, and hospital admissions shouldn&apos;t feel like a prison sentence.</p>
        <p className={styles.text}>These Bags of Hope provide essential items such as body wash, wipes, socks, and underwear, offering comfort and dignity to patients during a challenging time. Donated items are sorted into different bags, each providing a range of essentials as well as activites, snacks.</p>
        <p className={styles.text}>The bags are delivered to local psychiatric wards in and around the Vale of Glamorgan.</p>
        <p className={styles.text}>Go to our <a href="https://www.instagram.com/messagesof.hope/">Instagram page</a> to get the latest updates on the Bags of Hope project.</p>
      </ImagePanel>
