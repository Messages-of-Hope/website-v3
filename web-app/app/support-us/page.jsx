    ...
    <main className={styles.main}>
      ...
      <section className={styles.panel}>
        ...
        <div>
          ...
          <Button className={styles.button} colour="yellow" link="https://www.amazon.co.uk/hz/wishlist/ls/2B8A3SKRC0F49?ref_=wl_share" text="Amazon Wishlist" target="_blank"/>
        </div>
      </section>
