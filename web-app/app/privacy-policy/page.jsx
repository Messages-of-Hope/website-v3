  ...
  return (
    <main>
      ...
      <section className={styles.section}>
        ...
        <p><b><i>This summary provides key points from our privacy notice, but you can find out more details about any of these topics by clicking the link following each key point or by using our <a href="#toc">table of contents</a> below to find the section you are looking for.</i></b></p>
        ...
        <p><b>In what situations and with which parties do we share personal information?</b> We may share information in specific situations and with specific third parties. Learn more about <a href="#whoshare">when and with whom we share your personal information.</a></p>
        ...
        <p><b>How do you exercise your rights?</b> The easiest way to exercise your rights is by submitting a <a href="https://app.termly.io/notify/87d9d273-60b7-4557-a014-2604f397621c" target="_blank">data subject access request</a>, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.</p>
      ...
      <section className={styles.section} id="toc">
        ...
        <nav>
          <ul className={styles.ul}>
            ...
            <li><p><a href="#whoshare">4. When And With Whom Do We Share Your Personal Information?</a></p></li>
            <li><p><a href="#inforetain">5. How Long Do We Keep Your Information?</a></p></li>
            <li><p><a href="#infominors">6. Do We Collect Information From Minors?</a></p></li>
            <li><p><a href="#privacyrights">7. What Are Your Privacy Rights?</a></p></li>
            <li><p><a href="#DNT">8. Controls For Do-Not-Track Features</a></p></li>
            <li><p><a href="#otherlaws">9. Do Other Regions Have Specific Privacy Rights?</a></p></li>
            <li><p><a href="#policyupdates">10. Do We Make Updates To This Notice?</a></p></li>
            <li><p><a href="#contact">11. How Can You Contact Us About This Notice?</a></p></li>
            <li><p><a href="#request">12. How Can You Review, Update, Or Delete The Data We Collect From You?</a></p></li>
          </ul>
        </nav>
      </section>
      ...
      <section className={styles.section} id="legalbases">
        ...
        <ul>
          <li><p><b>Consent.</b> We may process your information if you have given us permission (i.e. consent) to use your personal information for a specific purpose. You can withdraw your consent at any time. Learn more about <a href="#withdrawconsent">withdrawing your consent</a>.</p></li>
          <li><p><b>Legal Obligations.</b> We may process your information where we believe it is necessary for compliance with our legal obligations, such as to cooperate with a law enforcement body or regulatory agency, exercise or defend our legal rights, or disclose your information as evidence in litigation in which we are involved.</p></li>
          <li><p><b>Vital Interests.</b> We may process your information where we believe it is necessary to protect your vital interests or the vital interests of a third party, such as situations involving potential threats to the safety of any person.</p></li>
        </ul>
      </section>
      ...
      <section className={styles.section} id="otherlaws">
        <h5>9. Do Other Regions Have Specific Privacy Rights?</h5>
        ...
        <ul>
          ...
          <li><p>General enquiries: <a href="mailto:enquiries@inforegulator.org.za">enquiries@inforegulator.org.za</a></p></li>
          <li><p>Complaints (complete POPIA/PAIA form 5): <a href="PAIAComplaints@inforegulator.org.za">PAIAComplaints@inforegulator.org.za</a> & <a href="POPIAComplaints@inforegulator.org.za">POPIAComplaints@inforegulator.org.za</a></p></li>
        </ul>
      </section>
      ...
      <section className={styles.section} id="contact">
        ...
        <p>If you have questions or comments about this notice, you may email us at <a href="mailto:contact@messagesofhope.co.uk">contact@messagesofhope.co.uk</a> or contact us by post at:</p>
